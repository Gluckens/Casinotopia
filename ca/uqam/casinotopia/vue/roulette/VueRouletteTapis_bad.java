...
public class VueRouletteTapis_bad extends Vue {
	...
	protected void addComponents() {
		...
		tapis.setName("tapis");
		/*gridBagLayout.setConstraints(tapis, gbh.setXY(0, 10).setWH(3, 1).setFill(gbh.BOTH).end());
		this.add(tapis);*/
		...
		/*JLabel lblTiti = new JLabel("titi");
		GridBagConstraints gbc_lblTiti = new GridBagConstraints();
		gbc_lblTiti.anchor = GridBagConstraints.NORTHWEST;
		gbc_lblTiti.gridx = 4;
		gbc_lblTiti.gridy = 7;
		add(lblTiti, gbc_lblTiti);*/
	}
