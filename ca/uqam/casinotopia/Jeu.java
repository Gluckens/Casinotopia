...
public class Jeu {
	...
	/*public Jeu() {
		...
		//this.lstParties = new ArrayList<Partie>();
	}*/
	...
	/**
	 * @param reglesJeu the reglesJeu to set
	 */
	...
	public int getNbrJoueursMin() {
		return nbrJoueursMin;
	}
	/**
	 * @param nbrJoueursMin the nbrJoueursMin to set
	 */
	...
	/**
	 * @param nbrJoueursMax the nbrJoueursMax to set
	 */
	...
	/**
	 * @param lstParties the lstParties to set
	 */
